...
やり取りを加えていきます。まずは、ユーザー登録から作りましょう。
...
<Link href='https://plantuml.com/ja/sequence-diagram'>公式ドキュメントを見る</Link>

<CustomBox>
  <IconButton text='Prev イントロダクション' link='/learn' startIcon={<ArrowBackIosIcon />} />
  <IconButton
    text='Next ユースケース図'
    link='/learn/ユースケース図'
